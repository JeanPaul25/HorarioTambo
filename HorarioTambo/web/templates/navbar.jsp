...
<html>      
    ...
    <body>
        ...
        <%
            ...
            <div class="btn-group col-5">            
                <div class="col-4 text-center"> 
                    <button type="button" class="btn bgyellow"> <a href="servletEmpleados"> Empleados </a> </button>
                </div>
                <div class="col-4 text-center"> 
        ...
        <%
            }if(opcion.equals("emp")){
            %>
            
            <div class="container-fluid justify-content-center col-2">                         
                <img src="images/LogoTambo.png" class="img-fluid w-100" alt="Logo Tambo">          
            </div>
            <div class="col-6 text-center text-light font-weight-bold"> Empleados </div>
            <div class="col-2 text-center"> 
                <button type="button" class="btn bgyellow"> <a href="servlet?opcion=dashboard">  Regresar </a> </button> 
            </div>
            <div class="col-2">
        ...
        <%
            }if(opcion.equals("horarioEmpleado")){
            ...
            <div class="col-6 text-center text-light font-weight-bold"> Horario Empleado: <%=idUsuario%> </div>
            <div class="col-2 text-center"> 
                <button type="button" class="btn bgyellow"> <a href="servletEmpleados">  Regresar </a> </button> 
            </div>
            <div class="col-2">
                <div>
                    <button type="button" class="btn bgyellow">
